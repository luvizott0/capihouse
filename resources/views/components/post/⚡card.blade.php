...
<div class="overflow-hidden border-2 rounded-xs border-border bg-white">
    ...
    <div class="p-4">
        ...
        <div class="flex items-center gap-6 pt-5">
            <button wire:click="likePost" class="flex items-center cursor-pointer gap-1 text-sm text-primary-600 hover:text-red-500 transition">
                @if($isLiked)
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 text-red-600">
