...
<div class="overflow-hidden border-2 rounded-xs border-border bg-white">
    ...
    <div class="p-4">
        ...
        <div class="flex items-center gap-6 pt-5">
            <button wire:click="likePost" class="flex items-center gap-1 text-sm text-primary-600 hover:text-red-500 transition">
