    ...
    <input
        {{
            $attributes->merge([
                ...
                'w-full resize-none overflow-hidden py-1.5 text-subtitle px-2.5 text-sm border border-border bg-primary-100 focus:outline-none focus:border-primary-400',
                'text-xs' => $xs,
                'text-sm' => $sm,
                'text-base' => $md,
                'text-lg' => $lg,
