 ...
 * @property-read Collection<int, \App\Models\Interest> $interests
 ...
 * @mixin \Eloquent
 */
#[Fillable(['name', 'username', 'email', 'banner_url', 'avatar_url', 'password', 'status', 'role', 'bio', 'birth', 'instagram', 'spotify'])]
